    ...
    *,
    ...
    synthesis_config = types.GenerateContentConfig(
        ...
        system_instruction=(
            ...
            "fields are the latest successfully checked Monday CRM values; use them for "
            "current Accounts, New Enq / Amend, TP Ref, Project Name and Zip Code, ahead "
            "of older document values or conversation history. State when a refresh is "
            "pending or failed if that affects an answer about current CRM details. A "
            "confirmed empty field is not set; do not fill it from historical evidence. "
            "Accounts can differ from an email sender's Company; Project Name is not "
            "Drawing Title, and a Zip Code area is not a full postcode. Clearly label a "
